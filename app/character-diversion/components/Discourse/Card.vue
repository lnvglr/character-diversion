<template>
	<NuxtLink :to="`/discourse/${discourse.id}`"
		class="flex flex-col min-h-[200px] rounded-md border border-beige-300 bg-beige-50 hover:bg-white hover:shadow-[10px_10px_0_0_black] duration-100">
