<template>
	<div
		...
		<div class="p-4 hover:bg-white cursor-pointer" @click="sidebarMinimized = !sidebarMinimized">
			...
			<p class="text-md max-w-lg markdown mt-2" v-html="$f.utils.renderMarkdown($state.discourse.current.attributes.content)"	v-if="!sidebarMinimized"></p>
		</div>
