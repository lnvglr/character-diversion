...
export default defineComponent({
	...
	computed: {
		source() {
			console.log(this.$strapi.api, typeof this.$strapi.media)
			const base = this.$strapi.media && this.$strapi.media !== 'undefined' && this.$strapi.media !== undefined ? this.$strapi.media : '';
